        ...
        return (
            <div className="pt-4 px-1" key={i}>
                <div className='w-3/3 py-3 sm:px-3 text-black mb-5 flex justify-between items-center shadow-[0_3px_10px_rgb(0,0,0,0.2)]'>
                    ...
                    <button onClick={(e) => filterelement(e)} name='btn' value={i} ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
